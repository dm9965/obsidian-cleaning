...
const Navigation = () => {
    return (
        <div className={"tw-w-lvw tw-fixed tw-top-0 tw-left-0 tw-border-b-4 tw-border-b-primary-orange tw-shadow-xl tw-flex tw-min-h-[5rem] tw-max-h-[5rem] tw-items-center tw-bg-primary-blue"}>
